...
{
    public class MartianFoil : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Main.player[Projectile.owner].buffTime[Main.player[Projectile.owner].FindBuffIndex(Mod.Find<ModBuff>("CounterCooldown").Type)] -= 10;
            }
        }
    }
}
