...
{
    public class RocketTurretCapsule : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            player.AddBuff(Mod.Find<ModBuff>("RocketTurret").Type, 18002);
            MPlayer mplayer = (MPlayer)player.GetModPlayer(Mod, "MPlayer");
            mplayer.rocketTurret = true;
            int p = Projectile.NewProjectile(Projectile.position.X, Projectile.position.Y, 0, 0, Mod.Find<ModProjectile>("RocketTurret").Type, Projectile.damage, Projectile.knockBack, Projectile.owner, 0, aiOut);
            return true;
        }
