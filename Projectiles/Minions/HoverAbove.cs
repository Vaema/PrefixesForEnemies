...
{
    public abstract class HoverAbove : Minion
    {
        ...
        public override void Behavior()
        {
            ...
            else
            {
                ...
                {
                    if (Main.projectile[k].active && Main.projectile[k].owner == Projectile.owner && Main.projectile[k].Name.Contains(" Elemental Spirit"))
                    {
                        num++;
                    }
                }
