...
{
    public class FencerFoil : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = Mod.Find<ModProjectile>("FencerFoil").Type;
            Item.scale = 1.1f;
            Item.shootSpeed = 5f;
        }
    ...
    {
      // DisplayName.SetDefault("Fencer's Foil");
      // Tooltip.SetDefault("Right-click to counter.\nCounter melee hits to deal damage");
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                player.AddBuff(Mod.Find<ModBuff>("CounterStanceFoil").Type, Item.useAnimation + bonus);
