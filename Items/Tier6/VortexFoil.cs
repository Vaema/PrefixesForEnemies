...
{
    public class VortexFoil : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = Mod.Find<ModProjectile>("VortexFoil").Type;
            Item.scale = 1.1f;
            Item.shootSpeed = 5f;
        }
    ...
    {
      // DisplayName.SetDefault("Vortex Foil");
      // Tooltip.SetDefault("Right-click to counter.\nCounter melee hits to stun and deal damage");
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                player.AddBuff(Mod.Find<ModBuff>("CounterStanceFoil4").Type, Item.useAnimation + bonus);
